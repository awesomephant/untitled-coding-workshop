...
module.exports = function (eleventyConfig) {
  eleventyConfig.addPlugin(inclusiveLangPlugin, {
    templateFormats: ["md"],
    words: "simply,obviously,basically,of course,clearly,just,everyone knows,however,easy,directory,directories,easy",
  });

  eleventyConfig.addPairedShortcode("todo", function (todoItems) {
    return `<div data-percentage='0' class='todo'><div class='progress'><div class='progress-inner'></div></div>
            ${todoItems}
</div>
            `;
  });
  ...
  eleventyConfig.addShortcode("fig", function (url, caption) {
    return `<figure><img loading="lazy" src='/untitled-coding-workshop/${url}'/><figcaption>${caption}</figcaption></figure>
            `;
  });
